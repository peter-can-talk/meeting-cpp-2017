...
QT_MOC_LITERAL(1, 8, 10), // "prediction"
QT_MOC_LITERAL(2, 19, 0), // ""
QT_MOC_LITERAL(3, 20, 7), // "predict"
QT_MOC_LITERAL(4, 28, 13) // "imageFilename"

    },
    "BackEnd\0prediction\0\0predict\0imageFilename"
};
...
void BackEnd::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->prediction((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->predict((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&BackEnd::prediction)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void BackEnd::prediction(int _t1)
{
