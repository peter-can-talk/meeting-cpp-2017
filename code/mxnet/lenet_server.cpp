...
class Socket {
 public:
  explicit Socket(int port) : server_socket(get_server_socket(port)) {
...
int main(int argc, char const* argv[]) {
  int port = (argc == 2) ? std::atoi(argv[1]) : 6666;
