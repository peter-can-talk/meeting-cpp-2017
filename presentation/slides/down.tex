...
%
%   % Label
%   \draw (5.5, -2.2) node {\textbf{Generative Adversarial Networks (GAN)}};
% \end{tikzpicture}
% \end{slide}
%
...
%   \path (0, 0) coordinate (r)
%         node {\includegraphics[scale=0.1]{cppcon-logo}};
%   \draw (r)+(0, -1.1) node {\footnotesize\texttt{128 x 128 x 3}};
%
...
%     }
%
%       \draw (1.5, -0.5) node {\textbf{Patterns}};
%   \end{tikzpicture}
%   \hspace{2cm}
%   \begin{tikzpicture}[thick]
%     \draw (0, 0) grid ++(3, 3);
...
%   \path (0, 0) coordinate (r)
%         node {\includegraphics[scale=0.1]{cppcon-logo}};
%   \draw (r)+(0, -1.1) node {\footnotesize\texttt{128 $\times$ 128 $\times$ 3}};
%
